...
export default function Chat({ mensajes, onEnviarMensaje, nombreJugador }) {
        ...
        {mensajes.map((msg, idx) => {
          ...
          return (
            ...
            >
              ...
              <div
                className={`max-w-[85%] px-3 py-1.5 rounded-xl text-sm font-medium break-words leading-snug ${
                  esMio
